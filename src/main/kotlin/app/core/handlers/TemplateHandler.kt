 ...
 */
object TemplateHandler : KLogging() {

    val templateDAO = DAOManager.getDAO(DAOManager.TABLE.TEMPLATES) as TemplateDAO

    fun createTemplate(template: Template): Boolean {
    ...
    fun getTemplateByTitle(title: String): Template {
        return templateDAO.getTemplateById(templateDAO.getTemplateIdByTitle(title), true)
    }
}